 ...
 */
const VERSION = "b92c903e72bc"
const PRECACHE = ["./","./assets/demo-DrSYmnvS.js","./assets/epub-BZ8eZPP6.js","./assets/index-C9ECPucq.css","./assets/index-tvoVI30q.js","./assets/pdf-ZEKVhlEe.js","./assets/pdf.worker.min-BmVo14Nb.mjs","./assets/search.worker-Cjmumks5.js","./apple-touch-icon.png","./favicon.ico","./favicon.svg","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./manifest.webmanifest"]
