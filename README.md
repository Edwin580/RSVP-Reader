...
- **Newsreader** (SIL Open Font License) for titles and book text, bundled with the app so it works offline, with optical sizes so large titles and small text each get a cut drawn for them; buttons and labels use the system font
